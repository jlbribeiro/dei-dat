...
\newcommand{\documentTitle}{Data Analysis and Transformation \\ TP2: Signals Frequency Analysis and Filtering}
\newcommand{\pdfTitle}{[ATD] TP2: Signals Frequency Analysis and Filtering}
...
\noindent Para as seguintes alíneas, foram utilizados os coeficientes e fases da Série de Fourier Trigonométrica já calculados em \emph{\nameref{subsec:ex_2_2}}, como referência para a escolha dos filtros.
...
\begin{center}
	...
	\captionof{figure}{Original signal (unit square wave, $T_0 = 2 \, \pi$) (blue) overlapped by the noisy signal (green) and the Fourier Series Filtered Signal (dashed, red).}
...
\begin{center}
	...
	\captionof{figure}{Noisy signal Fourier Series coefficients (blue) overlapped by the filtered noisy signal Fourier Series coefficients (red).}
...
\begin{center}
	...
	\captionof{figure}{Original signal (sawtooth wave, $T_0 = 2 \, \pi$) (blue) overlapped by the noisy signal (green) and the Fourier Series Filtered Signal (dashed, red).}
...
\begin{center}
	...
	\captionof{figure}{Original signal ($x(t) = cos(0) + cos\left(33 \, \pi \, t + \frac{7 \pi}{4}\right) + cos\left(9 \, \pi \, t + \frac{\pi}{4}\right)$, $T_0 = \frac{2}{3}$) (blue) overlapped by the noisy signal (green) and the Fourier Series Filtered Signal (dashed, red).}
...
\begin{center}
	...
	\captionof{figure}{Original signal ($x(t) = 2 \, cos(\pi) + 4 \, cos\left(4 \, t + \frac{\pi}{3}\right) + 2 \, cos\left(10 \, t + \frac{\pi}{2}\right)$, $T_0 = \pi$) (blue) overlapped by the noisy signal (green) and the Fourier Series Filtered Signal (dashed, red).}
...
\begin{center}
	...
	\captionof{figure}{Signal's Fourier Transform (module), $\omega \in [-30 \, \pi, 30 \, \pi] \, rad/s$, \texttt{step} $ = \pi/6$.}
	\label{fig:ex_4_1_module}
\end{center}

\begin{center}
	\includegraphics[width=0.70\textwidth]{images/ex_4_1_pha.png}
	\captionof{figure}{Signal's Fourier Transform (phase), $\omega \in [-30 \, \pi, 30 \, \pi] \, rad/s$, \texttt{step} $ = \pi/6$.}
...
\begin{center}
	...
	\captionof{figure}{Original signal, $x(t)$, (blue) overlapped by the Inverse Fourier Transform applied to $x(t) \, e^{-j \, \omega \, t}$ (red).}
	\label{fig:ex_4_2}
\end{center}
