...
\begin{center}
	...
	\captionof{figure}{Incremental signal reconstruction with 4 levels of resolution (using wavelet `db3')}
\end{center}

\begin{center}
	\includegraphics[width=0.85\textwidth]{images/ex_3_6_sym2_rec.png}
	\captionof{figure}{Incremental signal reconstruction with 4 levels of resolution (using wavelet `sym2')}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{Image with approximation coefficients of level 2.}
\end{center}
\begin{center}
...
\end{center}
\begin{center}
	\includegraphics[width=0.65\textwidth]{images/ex_4_2_d1.png}
	\captionof{figure}{Image with detail coefficients of level 2 and 1, with approximation coefficient of level 2.}
\end{center}
\end{document}
